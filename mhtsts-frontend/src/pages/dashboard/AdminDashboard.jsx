      ...
      <div className="mc-dashboard-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <p className="mc-page-subtitle" style={{ margin: '4px 0 0 0', fontSize: 12, color: 'var(--text-secondary)' }}>
            Welcome back, System Admin <strong>{currentUser?.firstName} {currentUser?.lastName}</strong>. Uptime is at 99.98% with active E2EE databases.
          </p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14 }}>
        ...
        <div className="mc-card" style={{ 
          ...
          <div>
            ...
            <strong style={{ fontSize: 22, fontWeight: 800, color: '#1E1B4B', margin: '4px 0', display: 'block' }}>{users.length > 0 ? users.length : 79}</strong>
        ...
        <div className="mc-card" style={{ 
          ...
          <div>
            ...
            <strong style={{ fontSize: 22, fontWeight: 800, color: '#1E1B4B', margin: '4px 0', display: 'block' }}>{clients.length > 0 ? clients.length : 154}</strong>
        ...
        <div className="mc-card" style={{ 
          ...
          <div>
            ...
            <strong style={{ fontSize: 22, fontWeight: 800, color: '#1E1B4B', margin: '4px 0', display: 'block' }}>{appointments.length > 0 ? appointments.length : 28}</strong>
        ...
        <div className="mc-card" style={{ 
          ...
          <div>
            <span style={{ fontSize: 10, color: 'var(--text-secondary)', fontWeight: 600, display: 'block', textTransform: 'uppercase' }}>Pending Notes</span>
            <strong style={{ fontSize: 22, fontWeight: 800, color: '#1E1B4B', margin: '4px 0', display: 'block' }}>3</strong>
            <span style={{ fontSize: 9, color: 'var(--color-danger)', fontWeight: 700 }}>Requires co-signs</span>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6 }}>
            ...
            {renderSparkline(sparkNotes, '#4338CA')}
          </div>
        </div>
        ...
        <div className="mc-card" style={{ 
          ...
          border: '1px solid rgba(239, 68, 68, 0.25)', padding: 14, borderRadius: 14, 
          display: 'flex', justifyContent: 'space-between', alignItems: 'center'
        }}>
          <div>
            <span style={{ fontSize: 10, color: '#EF4444', fontWeight: 700, display: 'block', textTransform: 'uppercase' }}>Crisis Alerts</span>
            <strong style={{ fontSize: 22, fontWeight: 800, color: '#B91C1C', margin: '4px 0', display: 'block' }}>1</strong>
            <span style={{ fontSize: 9, color: '#EF4444', fontWeight: 700 }}>High Risk: 1 Client</span>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6 }}>
            ...
            {renderSparkline(sparkCrisis, '#EF4444')}
          </div>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
        ...
        <div className="mc-card" style={{ padding: 16, borderRadius: 16 }}>
          <div className="mc-card-header" style={{ borderBottom: '1px solid var(--border-primary)', paddingBottom: 10, marginBottom: 12 }}>
            <h3 className="mc-card-title" style={{ fontSize: 13, fontWeight: 700, margin: 0 }}>Recent System & Clinical Activities</h3>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxHeight: 300, overflowY: 'auto' }}>
            <div style={{ display: 'flex', gap: 10 }}>
              <span style={{ fontSize: 16 }}>ðŸ†•</span>
              <div>
                <strong style={{ fontSize: 11, display: 'block', color: 'var(--text-primary)' }}>New Client Intake Completed</strong>
                <span style={{ fontSize: 10, color: 'var(--text-secondary)' }}>Client: Marcus Vance assigned to Dr. Emily Chen.</span>
                <span style={{ fontSize: 8, color: 'var(--text-tertiary)', display: 'block', marginTop: 2 }}>Intake packet verified</span>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <span style={{ fontSize: 16 }}>ðŸ“…</span>
              <div>
                <strong style={{ fontSize: 11, display: 'block', color: 'var(--text-primary)' }}>Appointment Completed</strong>
                <span style={{ fontSize: 10, color: 'var(--text-secondary)' }}>Client Alex Morgan finished CBT session with Dr. Rodriguez.</span>
                <span style={{ fontSize: 8, color: 'var(--text-tertiary)', display: 'block', marginTop: 2 }}>2 hours ago</span>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <span style={{ fontSize: 16 }}>âœï¸</span>
              <div>
                <strong style={{ fontSize: 11, display: 'block', color: 'var(--text-primary)' }}>SOAP Progress Note Completed</strong>
                <span style={{ fontSize: 10, color: 'var(--text-secondary)' }}>Dr. Thompson submitted session note for verification.</span>
                <span style={{ fontSize: 8, color: 'var(--text-tertiary)', display: 'block', marginTop: 2 }}>3 hours ago</span>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <span style={{ fontSize: 16 }}>ðŸš¨</span>
              <div>
                <strong style={{ fontSize: 11, display: 'block', color: '#EF4444' }}>Crisis Assessment Filed</strong>
                <span style={{ fontSize: 10, color: 'var(--text-secondary)' }}>High suicide risk alert logged for minor client. Supervisor notified.</span>
                <span style={{ fontSize: 8, color: '#EF4444', display: 'block', marginTop: 2 }}>Safety plan generated</span>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <div>
                ...
                <span style={{ fontSize: 10, color: 'var(--text-secondary)' }}>Claim #C9081 cleared by BlueCross for $240.00.</span>
                <span style={{ fontSize: 8, color: 'var(--text-tertiary)', display: 'block', marginTop: 2 }}>4 hours ago</span>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <span style={{ fontSize: 16 }}>ðŸ›¡ï¸</span>
              <div>
                <strong style={{ fontSize: 11, display: 'block', color: 'var(--text-primary)' }}>MFA Audit Event Logged</strong>
                <span style={{ fontSize: 10, color: 'var(--text-secondary)' }}>Admin user initialized database maintenance check. IP: 192.168.1.12</span>
                <span style={{ fontSize: 8, color: 'var(--text-tertiary)', display: 'block', marginTop: 2 }}>5 hours ago</span>
              </div>
            </div>
          </div>
        </div>
