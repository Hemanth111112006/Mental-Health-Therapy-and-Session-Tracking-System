...
// â”€â”€â”€ Inline SVG Icons â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function ClientDashboard() {
  ...
  // â”€â”€ KPI Data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const kpiCards = [
    {
      icon: <CalendarIcon />, label: 'Upcoming Appointments', value: '2',
      accent: '#6366f1', sublabel: 'Next: Jul 17',
    },
    {
  ...
  // â”€â”€ Outcome Measures trend data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div className="mc-page-container" style={styles.pageContainer}>
      ...
      <div className="mc-page-header" style={styles.header}>
        <div>
          ...
          <p className="mc-page-subtitle" style={{ fontSize: '15px' }}>
            Welcome back, <strong style={{ color: 'var(--color-primary)' }}>{firstName}</strong>! Here is a summary of your care journey.
          </p>
        </div>
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <button className="mc-btn mc-btn-primary mc-btn-sm" onClick={() => navigate('/messages')}>
      ...
      {/* â”€â”€ Next Appointment (Full Width Prominent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div style={{ marginBottom: '24px' }}>
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', marginBottom: '16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-secondary)', fontSize: '14px' }}>
                <ClockIcon color="var(--text-tertiary)" />
                10:00 AM â€“ 10:50 AM
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-secondary)', fontSize: '14px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-secondary)', fontSize: '14px' }}>
                <HeartIcon size={16} color="var(--text-tertiary)" />
                Individual Therapy Session
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-secondary)', fontSize: '14px' }}>
                <MapPinIcon color="var(--text-tertiary)" />
                In-Person Â· Room 204
              </div>
            </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '40px', fontWeight: '800', color: 'var(--text-primary)', lineHeight: 1 }}>5</div>
            <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.7)', marginTop: '4px' }}>days away</div>
          </div>
        </div>
      </div>

      {/* â”€â”€ Row: Treatment Plan + Safety Plan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div style={styles.mainGrid}>

        {/* Treatment Plan */}
        <SectionCard title="My Treatment Plan" icon={<TargetIcon />} accent="#6366f1">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{
              background: 'linear-gradient(135deg, #6366f108 0%, transparent 80%)',
              border: '1px solid #6366f120',
              borderRadius: '12px', padding: '16px',
            }}>
              <div style={{ fontSize: '12px', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: '6px' }}>Treatment Goal</div>
              <div style={{ fontSize: '14px', fontWeight: '600', color: 'var(--text-primary)', lineHeight: 1.5 }}>
                Reduce depressive symptoms and improve daily functioning
              </div>
            </div>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
              <InfoRow label="Therapist" value="Dr. Sarah Chen, LCSW" valueColor="#6366f1" />
              <div style={{ height: '1px', background: 'var(--border-primary)', margin: '4px 0' }} />
              <InfoRow label="Start Date" value="March 14, 2026" />
              <InfoRow label="Next Review" value="August 1, 2026" valueColor="#f59e0b" />
            </div>

            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                <span style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Overall Progress</span>
                <span style={{ fontSize: '14px', fontWeight: '700', color: '#6366f1' }}>65%</span>
              </div>
              <ProgressBar percent={65} color="#6366f1" height={10} />
            </div>

            <div style={{ display: 'flex', gap: '10px' }}>
              {[
                { label: '4 Goals', color: '#6366f1', bg: '#6366f118' },
                { label: '2 Achieved', color: '#22c55e', bg: '#22c55e18' },
                { label: '2 In Progress', color: '#f59e0b', bg: '#f59e0b18' },
              ].map((tag, i) => (
                <div key={i} style={{
                  flex: 1, textAlign: 'center', padding: '8px 4px', borderRadius: '8px',
                  background: tag.bg, border: `1px solid ${tag.color}25`,
                }}>
                  <div style={{ fontSize: '13px', fontWeight: '700', color: tag.color }}>{tag.label}</div>
                </div>
              ))}
            </div>

            <button className="mc-btn mc-btn-outline mc-btn-sm" style={{ width: '100%', justifyContent: 'center' }}>
        ...
        {/* Safety Plan */}
        <SectionCard title="Safety Plan" icon={<ShieldIcon />} accent="#22c55e">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{
              ...
              <div style={{
                ...
                background: '#22c55e18', border: '2px solid #22c55e40',
                display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
              }}>
                <ShieldIcon size={16} color="#22c55e" />
              </div>
              <div>
                <div style={{ fontSize: '14px', fontWeight: '700', color: '#22c55e' }}>Active Safety Plan</div>
                <div style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>Reviewed and up to date</div>
              </div>
            </div>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
              <InfoRow label="Created" value="April 20, 2026" />
              <div style={{ height: '1px', background: 'var(--border-primary)', margin: '4px 0' }} />
              <InfoRow label="Last Updated" value="June 30, 2026" valueColor="#22c55e" />
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
              {[
                { count: '3', label: 'Warning Signs', color: '#f59e0b', icon: <AlertTriangleIcon size={14} color="#f59e0b" /> },
                { count: '5', label: 'Coping Strategies', color: '#6366f1', icon: <CheckCircleIcon size={14} color="#6366f1" /> },
                { count: '2', label: 'Emergency Contacts', color: '#ef4444', icon: <PhoneIcon size={14} color="#ef4444" /> },
              ].map((item, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ fontSize: '22px', fontWeight: '800', color: item.color, lineHeight: 1 }}>{item.count}</div>
                  <div style={{ fontSize: '11px', color: 'var(--text-secondary)', marginTop: '2px', lineHeight: 1.3 }}>{item.label}</div>
                </div>
              ))}
            </div>

            <div style={{ borderRadius: '10px', background: '#ef444410', border: '1px solid #ef444420', padding: '12px 14px' }}>
              <div style={{ fontSize: '12px', fontWeight: '600', color: '#ef4444', marginBottom: '4px' }}>Crisis Line</div>
              <div style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>988 Suicide &amp; Crisis Lifeline Â· Call or Text <strong style={{ color: 'var(--text-primary)' }}>988</strong></div>
            </div>

            <button className="mc-btn mc-btn-primary mc-btn-sm" style={{ width: '100%', justifyContent: 'center', background: '#22c55e', borderColor: '#22c55e' }}>
              View My Safety Plan
            </button>
          </div>
        </SectionCard>
      ...
      {/* â”€â”€ Row: Outcome Measures + Messages + Billing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        ...
        <SectionCard title="Secure Messages" icon={<MessageIcon />} accent="#3b82f6">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div style={{ borderTop: '1px solid var(--border-primary)', paddingTop: '12px' }}>
              <button className="mc-btn mc-btn-outline mc-btn-sm" style={{ width: '100%', justifyContent: 'center' }} onClick={() => navigate('/messages')}>
        ...
        <SectionCard title="Billing Summary" icon={<CreditCardIcon />} accent="#8b5cf6">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '12px', color: '#22c55e', marginTop: '4px', fontWeight: '600' }}>âœ“ Account in good standing</div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: '13px', fontWeight: '600', color: 'var(--text-primary)' }}>$150.00 Â· Jun 30, 2026</div>
                </div>
                <span style={{
        ...
        <div className="mc-card-content">
          <div style={styles.quickActionsGrid}>
            ...
            <QuickAction
              ...
              icon={<TargetIcon size={16} color="var(--text-primary)" />}
