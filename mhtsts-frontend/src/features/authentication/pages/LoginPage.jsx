  ...
  const handleSocialClick = async (provider) => {
    ...
    const providerConfigs = {
      google: {
        ...
        lastName: activePortal === "CLIENT" ? "K" : "Chen",
        role: activePortal === "CLIENT" ? "CLIENT" : "THERAPIST",
      },
      microsoft: {
        name: "Microsoft",
        officialUrl: "https://login.microsoftonline.com",
        email: activePortal === "CLIENT" ? "hemanthk1106@outlook.com" : "psychiatrist@mindcare.com",
        firstName: activePortal === "CLIENT" ? "Hemanth" : "Mark",
        lastName: activePortal === "CLIENT" ? "K" : "Rivera",
        role: activePortal === "CLIENT" ? "CLIENT" : "PSYCHIATRIST",
      },
      apple: {
        name: "Apple",
        officialUrl: "https://appleid.apple.com/sign-in",
        email: activePortal === "CLIENT" ? "hemanthk1106@appleid.com" : "psychologist@mindcare.com",
        firstName: activePortal === "CLIENT" ? "Hemanth" : "Maya",
        lastName: activePortal === "CLIENT" ? "K" : "Patel",
    ...
    // Open official provider sign-in page without OAuth client_id errors
    ...
    addToast(
      "info",
      `Official ${config.name} Portal`,
      `Opening official ${config.name} sign-in page...`
    );

    try {
      // Authenticate via backend and issue real signed JWT token
